...
const formBacgroundColor = document.querySelector(".form-pic");
...
mode.addEventListener("click", () => {
  ...
  formBacgroundColor.style.backgroundColor = "gold";
  paragraph.style.color = "black";
  mode.addEventListener("click", () => {
    submit.style.backgroundColor = "gold";
    body.style.backgroundColor = "white";
    formBacgroundColor.style.backgroundColor = "black";
    paragraph.style.color = "white";
  });
});

// //zmenšení obrazku
// const picture = document.querySelector(".about-us-pic");
